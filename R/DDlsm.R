DDlsmh<-function(Niter,Y.i,Y.ia,M,N,D,Zs){
  ...
  while( i<Niter ){
    ...
    Lambda.0=DDupLambda.0(alpha.0, alpha.1, C,B,  Y.i, cont.i, Z.i, Z.a, Lambda.0, Lambda.1 ,p.lambda.0=1)
    ...
    Lambda.1=DDupLambda.1.ia( alpha.1, B, Y.ia,  cont.a, Z.i, Z.a, Lambda.0, Lambda.1 ,p.lambda.1=1)
